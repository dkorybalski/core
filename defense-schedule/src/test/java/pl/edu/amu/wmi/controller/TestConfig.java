...
import pl.edu.amu.wmi.DefenseScheduleConfiguration;

@SpringBootConfiguration
@EnableAutoConfiguration
public class TestConfig extends DefenseScheduleConfiguration {
    ...
    public void configureGlobal(AuthenticationManagerBuilder auth) throws Exception {
        auth.inMemoryAuthentication()
                ...
                .withUser("Student 1")
                .password("Haslo123")
                .authorities("PROJECT_ADMIN");
    }

    @Bean("testUserDetailsServiceDefenseSchedule")
